...
public final class TokenManager {
     ...
     */
    public String verifyToken(String token) throws NullPointerException, JWTVerificationException {
     ...
     */
    public String generateToken(String subject) throws JWTCreationException {
        return JWT.create()
                .withIssuer(ISSUER)
                .withSubject(subject)
